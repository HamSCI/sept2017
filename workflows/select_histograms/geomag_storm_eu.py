...
if __name__ == '__main__':
    ...
    run_name    = 'EU_quiet_baseline'
    data_dir_0  = 'data/histograms/EU_mids_0-3000km_dx30min_dy500km' 
    rd  = {}
#    rd['data_dir_0']    = data_dir_0
    rd['base_dir']      = os.path.join('data/histograms')
